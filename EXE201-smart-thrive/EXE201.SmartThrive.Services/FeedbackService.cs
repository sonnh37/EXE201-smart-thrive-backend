...
public class FeedbackService : BaseService<Feedback>, IFeedbackService
{
    ...
    public async Task<PagedResponse<FeedbackResult>> GetAllFiltered(FeedbackGetAllQuery query)
    {
        ...
        return ResponseHelper.CreatePaged(feedbacksResultWithTotal, query);
    }
}